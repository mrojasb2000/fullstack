...
func refreshUserTable() error {
	...
	log.Printf("Seccessfully refreshed table")
...
func refreshUserAndPostTable() error {
	server.DB.Exec("SET foreign_key_checks=0")
	// NOTE: when deleting first detele Post as Post is depending on User table
...
func seedUsersAndPosts() ([]models.User, []models.Post, error) {
	...
	var posts = []models.Post{
		models.Post{
			Title:   "Title 1",
			Content: "Hello wordl 1",
		},
		models.Post{
			Title:   "Title 2",
			Content: "Hello wordl 2",
		},
	}
